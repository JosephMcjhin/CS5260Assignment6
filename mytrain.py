...
def main(training_config):
    ...
    #optimizer = coordinator.wrap_optimizer(optimizer)
    ...
    model, optimizer, criterion, lr_sheduler, booster = setup_booster(model, optimizer, criterion, lr_scheduler, training_config['plugin'])
...
def setup_booster(model, optimizer, criterion, lr_scheduler, plugin_type):
    plugin = {
    ...
    return model, optimizer, criterion, lr_scheduler, booster
